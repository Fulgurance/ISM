module ISM
    ...
    module Default
        ...
        module CommandLine
            ...
            SystemName = "#{Name}"
            SystemId = "250"
            NeedSuidBitText = "#{Name.upcase} can't run a command that required superuser access. Make sure that #{Name.upcase} have the bit SUID and SGID set."
            ...
            CheckText = "Checking "
            CheckingAdditionsText = "Downloading additions"
            ExtractText = "Extracting "
            ExtractingAdditionsText = "Downloading additions"
            PatchText = "Patching "
