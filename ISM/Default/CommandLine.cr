module ISM
    ...
    module Default
        ...
        module CommandLine
            ...
            LockSystemAccessSecurityNotification = "This task can only be performed as root. It unlock temporary the access of /lib,/bin and /sbin."
            UnlockSystemAccessSecurityNotification = "ISM need to lock the access to system critical points"
            UnlockSystemAccessSecurityNotification = "This task can only be performed as root. It will lock the access of /lib,/bin and /sbin."
