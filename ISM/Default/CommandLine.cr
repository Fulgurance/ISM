module ISM
    ...
    module Default
        ...
        module CommandLine
            ...
            RunGtkQueryImmodules2CommandSecurityNotificationReasonText = "ISM need to update the input method cache for GTK."
            RunGtkQueryImmodules2CommandSecurityNotificationDetailsText = "To perform this task, a root access is required. It will update the GTK input method database."
            RunGtkQueryImmodules3CommandSecurityNotificationReasonText = "ISM need to update the input method cache for GTK."
            ...
            LockingSystemAccessText = "Locking the access of the system critical points"
