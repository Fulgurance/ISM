module ISM
    ...
    class CommandLineSystemInformation
        ...
        def self.filePath : String
            return "#{(!Ism.systemInformation.handleUserAccess || Ism.settings.installByChroot) && Ism.settings.rootPath != "/" ? Ism.settings.rootPath : "/"}#{ISM::Default::CommandLineSystemInformation::SystemInformationFilePath}"
