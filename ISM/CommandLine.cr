module ISM
    ...
    class CommandLine
        ...
        def recordSystemCall(exitCode : Int32, command : String, path : String, environment : Hash(String,String))
            @lastRecordedSystemCall = ISM::SystemCallRecord.new(exitCode, command, path, environment)
        end
