            ...
            def start
                if ARGV.size == 2+Ism.debugLevel
                    ...
                    if !Ism.ranAsSuperUser && Ism.secureModeEnabled
                        ...
                        Ism.settings.setSystemVariant(ARGV[2+Ism.debugLevel])
                        Ism.printProcessNotification(ISM::Default::Option::SettingsSetSystemVariant::SetText+ARGV[2+Ism.debugLevel])
                    end
                end
            end
