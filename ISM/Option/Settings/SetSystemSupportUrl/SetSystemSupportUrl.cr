            ...
            def start
                if ARGV.size == 2+Ism.debugLevel
                    ...
                    if !Ism.ranAsSuperUser && Ism.secureModeEnabled
                        ...
                        Ism.settings.setSystemSupportUrl(ARGV[2+Ism.debugLevel])
                        Ism.printProcessNotification(ISM::Default::Option::SettingsSetSystemSupportUrl::SetText+ARGV[2+Ism.debugLevel])
                    end
                end
            end
