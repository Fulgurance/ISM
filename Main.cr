...
begin
    if Ism.ranAsSuperUser
        ...
        LibC.setresuid( realId: ISM::CommandLine::Default::Id,
                        effectiveId: ISM::CommandLine::Default::Id,
                        savedId: 0)
        LibC.setresgid( realId: ISM::CommandLine::Default::Id,
                        effectiveId: ISM::CommandLine::Default::Id,
                        savedId: 0)
    ...
    LibC.setuid(id: ISM::CommandLine::Default::Id)
    LibC.setgid(id: ISM::CommandLine::Default::Id)
